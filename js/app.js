const searchPhone = () => {
    ...
    if (searchText == '') {
        ...
        fetch(url)
            .then(res => res.json())
            .then(data => searchResultDisplay(data.data))
        ...
        phones.forEach(phone => {
            ...
            <div id="phone-card" class="border-0 shadow-lg mx-3 card h-100">
                ...
                <div class="card-body ms-2 my-3">
                    ...
                    <button onclick="phoneDetails(${phone.slug.id})" class="btn bg-info mt-3 w-50" type="button" id="details-button">Details</button>
                </div>
            </div>  
        `
